<x-app-layout>
                                    ...
                                    <tr
                                        ...
                                        <td class="px-6 py-4">
                                            <button type="button" data-id="{{ $k->id }}"
                                                ...
                                                data-modal-target="sourceModalEdit" data-produk="{{ $k->produk }}"
                                                data-modal-target="sourceModalEdit" data-harga="{{ $k->harga }}"
    ...
    <script>
        ...
        const produkDelete = async (id, produk) => {
            let tanya = confirm(`Apakah anda yakin untuk menghapus ${produk} ?`);
            if (tanya) {
