<x-app-layout>
                                    ...
                                    <tr
                                        ...
                                        <td class="px-6 py-4">
                                            <button type="button" data-id="{{ $k->id }}"
                                                ...
                                                data-konsinyasi="{{ $k->konsinyasi }}" onclick="editSourceModal(this)"
                ...
                <form method="POST" id="formSourceModalEdit">
                    ...
                    <div class="flex flex-col p-4 space-y-6">
                        <div class="mb-5">
                            <label for="konsinyasi"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Konsinyasi</label>
                            <input type="text" id="konsinyasi_edit" name="konsinyasi"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                required />
                        </div>
                    </div>
    ...
    <script>
        const functionAdd = () => {
            ...
            // Set form action URL
            let url = "{{ route('konsinyasi.store') }}";
        ...
        const editSourceModal = (button) => {
            ...
            document.getElementById('konsinyasi_edit').value = konsinyasi;
        ...
        const konsinyasiDelete = async (id, konsinyasi) => {
            let tanya = confirm(`Apakah anda yakin untuk menghapus ${konsinyasi} ?`);
            if (tanya) {
